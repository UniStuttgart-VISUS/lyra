...
/*
 * LYRA_NAMESPACE::detail::create
 */
LYRA_NAMESPACE::timestamp
LYRA_NAMESPACE::timestamp::create(
        _In_ const int year,
...
/*
 * LYRA_NAMESPACE::detail::from_system_clock
 */
LYRA_NAMESPACE::timestamp
LYRA_NAMESPACE::timestamp::from_system_clock(void) {
    return std::chrono::system_clock::now();
}


/*
 * LYRA_NAMESPACE::timestamp::from_time_t
 */
LYRA_NAMESPACE::timestamp
LYRA_NAMESPACE::timestamp::from_time_t(_In_ const std::time_t t) {
 ...
 */
LYRA_NAMESPACE::timestamp
LYRA_NAMESPACE::timestamp::from_tm(_In_ std::tm& t) {
#if defined(_WIN32)
...
/*
 * LYRA_NAMESPACE::timestamp::today
 */
LYRA_NAMESPACE::timestamp LYRA_NAMESPACE::timestamp::today(void) {
    std::time_t now;
    std::time(&now);
...
/*
 * LYRA_NAMESPACE::timestamp::zero
 */
const LYRA_NAMESPACE::timestamp
LYRA_NAMESPACE::timestamp::zero(0);


/*
 * LYRA_NAMESPACE::timestamp::unix_offset
 */
const LYRA_NAMESPACE::timestamp::value_type
LYRA_NAMESPACE::timestamp::tick_rate;
